  ...
  computed: {
    filteredTodos: function () {
      return this.todos.filter((todo) => {
        if (this.filter === "active" && todo.done === false) return true;
        else if (this.filter === "completed" && todo.done === true) return true;
        ...
        <ul class="todo-list">
          {this.filteredTodos.map((todo) => {
            return (
              ...
              >
                <div class="view">
                  <input type="checkbox" class="toggle" vModel={todo.done} />
                  <label vOn:dblclick={() => this.editTodo(todo)}>
                    {todo.text}
                  </label>
                  <button
                    class="destroy"
                ...
                <input
                  ...
                  value={todo.text}
                  vOn:blur={(e) => this.completeEdit(e, todo, true)}
                  vOn:keyup_enter={(e) => this.completeEdit(e, todo, true)}
                  vOn:keyup_esc={(e) => {
                    this.completeEdit(e, todo, false);
                  }}
                />

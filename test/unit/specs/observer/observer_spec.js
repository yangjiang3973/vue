...
describe('Observer', function () {
    ...
    //* ?? is this necessary? when call Observer, we usuallt pass data as {}.
    //* this is for checking non-standard data?
    ...
    // partially added: until `expect(ob instanceof Observer).toBe(true);`
